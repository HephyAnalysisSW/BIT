...
from toy_models import exponential as model
theta    = 0.001
...
model.score_theory.Draw()
#score_theory.GetYaxis().SetRangeUser(.4, 2)
model.score_theory.GetYaxis().SetRangeUser(model.min_score_theory, model.max_score_theory)
counter=0
